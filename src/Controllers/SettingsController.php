...
use julio101290\boilerplatesettings\Models\SettingsModel;
...
class SettingsController extends BaseController {
    ...
    public function index() {
        ...
        $datos = $this->settings->where("id", 1)->first();
    ...
    public function save() {
         ...
         * 
         */
        return redirect()->back()->with('sweet-success', lang("settings.saveSucessMsg"));
    }
}
